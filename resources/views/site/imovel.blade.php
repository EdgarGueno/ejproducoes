...
<div class="container">
            ...
            <div class="col s12 m8">
                <div class="row">
                    ...
                    <div class="row" align="center">
                        <button onclick="sliderPrev()" class="btn red">Anterior</button>
                        <button onclick="sliderNext()" class="btn red">Próxima</button>
                    </div>
                </div> 
        ...
        <div class="col s12 m4">
            ...
            <p><b> Cep: </b> 83.587-710</p>
            <p><b> Cidade:</b> Pinhais-PR</p>
